...
public partial class Transactions_PurchaseInvoice :BasePage
{
    ...
    string Tables = "vw_TrnPurchaseInvoice";
    string PK = "PurchaseInvNo";
    string Fields = "PurchaseInvNo,PurchaseInvDate,PurchaseOrderNo,SupplierName,SupInvDate,PurchaseInvStatus,PurchaseInvAmt";
    string Filter = "";
    string Group = "";
    string sSortCol = "PurchaseInvNo";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Utility.RedirectToLoginPage("PurchaseInvoice.aspx");
        }
        ...
        if (!IsPostBack)
        {
            ...
            Utility.FillFilterDropDown(this.ddSearchField1, "SearchFieldDesc", "SearchFieldID", "SF", "PurchaseInvoice");
            Utility.FillFilterDropDown(this.ddSearchCondition1, "FilterDesc", "FilterID", "FC", "PurchaseInvoice");
            Utility.FillFilterDropDown(this.ddSearchCondition2, "FilterDesc", "FilterID", "FC", "PurchaseInvoice");
            Utility.FillFilterDropDown(this.ddSearchCondition3, "FilterDesc", "FilterID", "FC", "PurchaseInvoice");
            Utility.FillFilterDropDown(this.ddSearchField2, "SearchFieldDesc", "SearchFieldID", "SF", "PurchaseInvoice");
            Utility.FillFilterDropDown(this.ddSearchField3, "SearchFieldDesc", "SearchFieldID", "SF", "PurchaseInvoice");

            ReadPageState("PurchaseInvoice", out PageNumber, out sSortCol, out sSortOrder);
            if (PageNumber > 1)
            {
                PagerCtrl1.CurrentIndex = PageNumber;
                PagerCtrl2.CurrentIndex = PageNumber;
                BuildSql(PageNumber);
                KillSession("PurchaseInvoice");
            }
            else
            {
    ...
    private void BuildSql(int PageNo)
    {
        ...
        DataSet ds = BLL.Transaction.PurchaseInvoice.BindGrid(spName, new object[] { Tables, PK, sSortCol, PageNumber, iPageSize, Fields, cFilter, Group, sSortOrder });
    ...
    protected void dgList_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            if (e.CommandName == "Del")
            {
                ...
                sGotoUrl = "PurchaseInvoiceView.aspx?Action=C&ID=" + ((Label)e.Item.FindControl("lblPurchaseInvNo")).Text.Trim();
            ...
            else if (e.CommandName == "Edit")
            {
                string sGotoUrl;
                StorePageState("PurchaseInvoice", PagerCtrl1.CurrentIndex, sSortCol, sSortOrder);
                sGotoUrl = "PurchaseInvoiceTrn.aspx?Action=E&ID=" + ((Label)e.Item.FindControl("lblPurchaseInvNo")).Text.Trim();
                Response.Redirect(sGotoUrl);
            }
            else if (e.CommandName == "View")
            {
                string sGotoUrl;
                StorePageState("PurchaseInvoice", PagerCtrl1.CurrentIndex, sSortCol, sSortOrder);
                sGotoUrl = "PurchaseInvoiceView.aspx?Action=V&ID=" + ((Label)e.Item.FindControl("lblPurchaseInvNo")).Text.Trim();
                Response.Redirect(sGotoUrl);
            }
    ...
    protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
        {
            ...
            if ((string)(DataBinder.Eval(e.Item.DataItem, "PurchaseInvStatus")) == "CAN")
            {
