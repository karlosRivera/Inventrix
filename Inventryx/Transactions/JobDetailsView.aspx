<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="JobDetailsView.aspx.cs" Inherits="Transactions_JobDetailsView" %>
        ...
        <tr>
            <td align="left">
                <table id="tblHead1" class="topHeading" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Job Details View</asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>  
                ...
                <tr>
                    <td colspan="2" align="center" style="height: 14px; text-align: left">
                        <table border="0" cellpadding="1" cellspacing="0" style="width: 100%; position: relative; height: 100%">
                            <tr>
                                <td style="width: 18%; height: 6px;" valign="top">
                                    <asp:Label ID="Label1" runat="server"  Text="Job No." Font-Bold="True"></asp:Label></td>
                                <td style="width: 29%; height: 6px;" valign="top">
                                    <asp:Label ID="lblJobNo" runat="server" Style="position: relative"></asp:Label></td>
                                <td style="width: 10%; height: 6px;" valign="top">
                                    <asp:Label ID="Label3" runat="server" Font-Bold="True" Text="Job Address"></asp:Label></td>
                                <td style="width: 45%;" valign="top" rowspan="3">
                                    <asp:Label ID="lblJobAddress" runat="server" Height="44px" Style="position: relative"
                                        Width="315px"></asp:Label></td>
                            </tr>
                            <tr>
                                <td style="width: 18%" valign="top">
                                    <asp:Label ID="Label2" runat="server"  Text="Job Start Date" Font-Bold="True"></asp:Label></td>
                            ...
                            <tr>
                                ...
                                <td style="width: 29%; height: 7px;" valign="top">
                                    <asp:Label ID="lblCustomer" runat="server" Style="position: relative"></asp:Label></td>
                                <td style="width: 10%; height: 7px;" valign="top">
                                    </td>
                            </tr>
                            <tr>
                                <td style="width: 18%" valign="top">
                                ...
                                <td style="width: 10%" valign="top">
                                    <asp:Label ID="Label6" runat="server" Font-Bold="True" Text="Job City"></asp:Label></td>
                                <td style="width: 45%" valign="baseline">
                                    <asp:Label ID="lblJobCity" runat="server" Style="position: relative"></asp:Label></td>
                            </tr>
                            <tr>
                                <td style="width: 18%; height: 15px;" valign="top">
                                    </td>
                                <td style="width: 29%; height: 15px;" valign="top">
                                    </td>
                                <td style="width: 10%; height: 15px;" valign="top">
                                    <asp:Label ID="Label13" runat="server" Font-Bold="True" Text="Job Pin"></asp:Label></td>
                                <td style="width: 45%; height: 15px;" valign="baseline">
                                    <asp:Label ID="lblJobPin" runat="server" Style="position: relative"></asp:Label></td>
                            </tr>
                            <tr>
                                <td style="width: 18%" valign="top">
                                    </td>
                            ...
                            <tr>
                                <td style="width: 18%; height: 43px;" valign="top">
                                ...
                                <td style="width: 25%; height: 43px;" colspan="3" valign="top">
                                    <asp:Label ID="lblRemarks" runat="server" Style="position: relative" Height="40px" Width="454px"></asp:Label></td>
                            </tr>
                            <tr>
                                <td style="width: 18%; height: 6px" valign="top">
                            ...
                            <tr>
                                <td style="width: 18%; height: 54px" valign="top">
                            ...
                            <tr>
                                ...
                                <td colspan="3" style="width: 25%; height: 7px" valign="top">
                                </td>
                            </tr>
                ...
                <tr>
                    <td align="center" colspan="2" style="height: 15px; text-align: left">
                        <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundColumn DataField="WorkDate" HeaderText="Work Date">
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" Wrap="False" />
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="LabourCategoryName" HeaderText="Lab. Category">
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" Wrap="False" />
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="LabourRate" HeaderText="Labour Rate">
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Right" Wrap="False" />
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Right" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="NoOfLabour" HeaderText="Labour No.">
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Right" Wrap="False" />
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Right" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="WorkHour" HeaderText="Working Hour">
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Right" Wrap="False" />
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Right" Wrap="False" />
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="LabourAmt" HeaderText="Labour Amt.">
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Right" Wrap="False" />
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Right" Wrap="False" />
                    ...
                    <td align="center" colspan="2" style="height: 15px; text-align: left">
                        <table border="0" cellpadding="1" style="width: 100%; position: relative; left: 0px; top: 0px;">
                            <tr>
                                ...
                                <td style="width: 100px">
                                                <asp:Label ID="Label12" Font-Bold="True" runat="server" Style="position: relative" Text="Lab. Work Total"></asp:Label></td>
                                <td style="width: 100px" align="right">
                                    <asp:Label ID="lblLabWorkTotal" runat="server" Style="position: relative"></asp:Label></td>
                            </tr>
                        </table>
                    </td>
                </tr>
            ...
            <tr>
                <td colspan="2" align="right"  class="entryBoxFooter">
                    ...
                    <input id="btnBack" class="button" onclick="document.location.href='JobDetails.aspx'"  style="position: relative" type="button" value="Back" />&nbsp;</td>
            </tr>
            </table>
        </td>
        </tr>
