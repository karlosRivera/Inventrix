<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="GoodsReceiptNoCancel.aspx.cs" Inherits="Transactions_GoodsReceiptNoCancel" Title="Untitled Page" %>
                        ...
                        <asp:DataGrid ID="dgList" runat="server" AutoGenerateColumns="False" CellPadding="3"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Receive Qty">
                                    <HeaderStyle Font-Bold="True" HorizontalAlign="Right" Width="15%" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblRcvQty" runat="server"   Style="position: relative"
                        ...
                        <table style="width: 100%; position: relative; height: 100%">
                            <tr>
                                ...
                                <td style="width: 80%" valign="top">
                                    &nbsp;<cc1:GMDatePicker ID="txtCancelDate" runat="server" CalendarFont-Names="Arial"
                                        CalendarTheme="Blue" CssClass="INPUTblack" Style="position: relative">
                            ...
                            <tr>
                                ...
                                <td style="width: 80%; height: 66px;" valign="top">
                                    <asp:TextBox ID="txtCancelReason" runat="server" Columns="50" CssClass="INPUTblack" Height="58px"
                                        MaxLength="200" Rows="10" Style="position: relative; top: 2px" TextMode="MultiLine"
            ...
            <tr>
                <td colspan="2" align="right"  class="entryBoxFooter">
                    <asp:Button ID="btnSave" runat="server" CssClass="button" OnClick="btnSave_Click"
                        Style="left: 6px; position: relative" Text="Cancel" />
