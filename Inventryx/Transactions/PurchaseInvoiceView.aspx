<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="PurchaseInvoiceView.aspx.cs" Inherits="Transactions_PurchaseInvoiceView" %>
        ...
        <tr>
            <td align="left">
                <table id="tblHead1" class="topHeading" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Purchase Invoice View</asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>  
                        ...
                        <table border="0" cellpadding="1" cellspacing="0" style="width: 100%; position: relative; height: 100%">
                            <tr>
                                <td style="width: 16%; height: 21px;" valign="top">
                                    <asp:Label ID="Label1" runat="server"  Text="Purchase Inv. No." Font-Bold="True"></asp:Label></td>
                                <td style="width: 25%; height: 21px;" valign="top">
                                    <asp:Label ID="lblPurchaseInvNo" runat="server" Style="position: relative"></asp:Label></td>
                            ...
                            <tr>
                                <td style="width: 16%" valign="top">
                                    <asp:Label ID="Label2" runat="server"  Text="Purchase Inv. Date" Font-Bold="True"></asp:Label></td>
                                <td style="width: 25%" valign="top">
                                    <asp:Label ID="lblPurchaseInvDate" runat="server" Style="position: relative"></asp:Label></td>
                                <td style="width: 15%" valign="top">
                                    <asp:Label ID="Label3" runat="server" 
                                        Text="Sup. Inv. Date" Font-Bold="True" style="position: relative"></asp:Label></td>
                                <td style="width: 45%" valign="top">
                                    &nbsp;<asp:Label ID="lblSupInvDate" runat="server" Style="position: relative"></asp:Label></td>
                            </tr>
                            <tr>
                                <td style="width: 16%; height: 5px;" valign="top">
                                    <asp:Label ID="Label5" runat="server"  Text="Supplier" Font-Bold="True"></asp:Label></td>
                                <td style="width: 25%; height: 5px;" valign="top">
                                ...
                                <td style="width: 15%; height: 5px;" valign="top">
                                    <asp:Label ID="Label6" runat="server" Font-Bold="True" Style="position: relative"
                                        Text="Sup. Inv. No."></asp:Label></td>
                                <td style="width: 45%; height: 5px;" valign="baseline">
                                    &nbsp;<asp:Label ID="lblSupInvNo" runat="server" Style="position: relative" Width="224px"></asp:Label></td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 25%; height: 46px;" colspan="3" valign="top">
                                    <asp:Label ID="lblRemarks" runat="server" Style="position: relative" Height="44px" Width="427px"></asp:Label></td>
                            </tr>
                            <tr>
                    ...
                    <td align="center" colspan="2" style="height: 15px; text-align: left">
                        <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="PO Rate">
                                    <HeaderStyle Font-Bold="True" Width="5%" Wrap="False" HorizontalAlign="Right" />
                                    <ItemStyle HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblPORate" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PORate") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="Inv Rate">
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblInvRate" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.InvRate") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Right" Width="5%" Wrap="False" />
                                </asp:TemplateColumn>

                                <asp:TemplateColumn HeaderText="Product Qty">
                                    <HeaderStyle Font-Bold="True" Width="5%" Wrap="False" HorizontalAlign="Right"/>
                                    <ItemStyle HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblProductQty" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ProductQty") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:TemplateColumn HeaderText="GRN Qty">
                                    <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Right" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblGRNQty" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.GRNQty") %>'></asp:Label>
                                    </ItemTemplate>
                                    <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                        Font-Underline="False" HorizontalAlign="Right" Width="5%" Wrap="False" />
                                </asp:TemplateColumn>
                ...
                <table id="tblSearch2" class="searchBox" align="center" border="0" cellpadding="2" cellspacing="0" style="height: 1px" >
                    <tr style="font-weight: bold; color: #000000">
                        <td style="height: 17px" class="entryBoxHeader" colspan="2">
                            Purchase Invoice Cancellation</td>
                    </tr>
                    <tr style="font-weight: bold; color: #000000">
            ...
            <tr>
                <td colspan="2" align="right"  class="entryBoxFooter">
                    ...
                    <input id="btnBack" class="button" onclick="document.location.href='PurchaseInvoice.aspx'"  style="position: relative" type="button" value="Back" />&nbsp;</td>
            </tr>
            </table>
        </td>
        </tr>
