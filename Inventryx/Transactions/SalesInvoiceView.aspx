<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="SalesInvoiceView.aspx.cs" Inherits="Transactions_SalesInvoiceView" Title="Untitled Page" %>
        ...
        <tr>  
            ...
            <tr>
                <td colspan="2" align="right"  class="entryBoxFooter">
                    <asp:Button ID="btnPrint" runat="server" Style="position: relative; left: 3px;" Text="Print"  CssClass="button" OnClick="btnPrint_Click" />
