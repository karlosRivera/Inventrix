<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="GoodsReceiptNoList.aspx.cs" Inherits="GoodsReceiptNoList" Title="Untitled Page" %>
        ...
        <tr>
            <td align="left" colspan="2" style="width: 740px; height: 22px">
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Goods Receipt Notes Listing</asp:Label>
                        </td>
                        <td align="right">
                            <input id="btnAdd" runat="server" name="btnAdd" onclick ="javascript:GotoPage('GoodsReceiptNoMaster.aspx?Action=A');" 
                            style="position: relative" type="button" value="Add New GRN" class="button" />
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td valign="top" style="height: 115px">
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="GRN No" SortExpression="GRNNo">
                                        <HeaderStyle Font-Bold="True" Width="10%" Wrap="False" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblGRNNo" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.GRNNo") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="GRN Date" SortExpression="GRNDate">
                                        <HeaderStyle Font-Bold="True" Width="5%" Wrap="False" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblGRNDate" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.GRNDate","{0:dd/MM/yyyy}") %>'>
                                                                                                   
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Purchase Order No" SortExpression="PurchaseOrderNo">
                                    ...
                                    <asp:TemplateColumn HeaderText="GRN Status" SortExpression="GRNStatus">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblGRNStatus" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.GRNStatus") %>'>
											</asp:Label>
                                        </ItemTemplate>
