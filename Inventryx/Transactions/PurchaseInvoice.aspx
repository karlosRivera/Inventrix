<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="PurchaseInvoice.aspx.cs" Inherits="Transactions_PurchaseInvoice" %>
        ...
        <tr>
            <td align="left" colspan="2" style="width: 740px; height: 22px">
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Purchase Invoice Listing</asp:Label>
                        </td>
                        <td align="right">
                            <input id="btnAdd" runat="server" name="btnAdd" onclick ="javascript:GotoPage('PurchaseInvoiceTrn.aspx?Action=A');" 
                            style="position: relative" type="button" value="Add Purchase Invoice" class="button" />
                        </td>
                    </tr>
                </table>
            </td>
                            ...
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Inv. No">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPurchaseInvNo" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PurchaseInvNo") %>'></asp:Label>
                                        </ItemTemplate>
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Width="15%" Wrap="False" />
                                    </asp:TemplateColumn>
                                    <asp:BoundColumn DataField="PurchaseInvDate" HeaderText="Inv. Date" SortExpression="PurchaseInvDate">
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Width="10%" Wrap="False" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="PurchaseOrderNo" HeaderText="PO. Order" SortExpression="PurchaseOrderNo">
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Width="10%" Wrap="False" />
                                    </asp:BoundColumn>
                                    ...
                                    <asp:BoundColumn DataField="SupInvDate" HeaderText="Sup. Inv. Date" SortExpression="SupInvDate">
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Width="10%" Wrap="False" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="PurchaseInvStatus" HeaderText="Inv. Status" SortExpression="PurchaseInvStatus">
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Width="5%" Wrap="False" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="PurchaseInvAmt" HeaderText="Inv. Amt." SortExpression="PurchaseInvAmt">
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
