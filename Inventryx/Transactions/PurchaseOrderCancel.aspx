<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PurchaseOrderCancel.aspx.cs" Inherits="Transactions_PurchaseOrderCancel" Title="Untitled Page" %>
        ...
        <tr>  
            ...
            <tr>
                <td colspan="2" align="right"  class="entryBoxFooter">
                    <asp:Button ID="btnCancel" runat="server" CssClass="button" Style="position: relative"
                        Text="Cancel" OnClick="btnSave_Click" />
