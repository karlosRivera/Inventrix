<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DeliveryNoteCancel.aspx.cs" Inherits="Transactions_DeliveryNoteCancel" Title="Untitled Page" %>
                ...
                <table id="tblHead1" class="topHeading" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            ...
                            Delivery Note Cancel</asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <tr>
                <td colspan="2" align="right"  class="entryBoxFooter">
                    <asp:Button ID="btnCancel" runat="server" CssClass="button" OnClick="btnCancel_Click"
                        Style="position: relative" Text="Cancel" />
