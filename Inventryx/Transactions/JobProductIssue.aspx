<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="JobProductIssue.aspx.cs" Inherits="Transactions_JobProductIssue" %>
        ...
        <tr>
            <td align="left" colspan="2" style="width: 740px; height: 22px">
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Job Product Issue Listing</asp:Label>
                        </td>
                        <td align="right">
                            <input id="btnAdd" runat="server" name="btnAdd" onclick ="javascript:GotoPage('JobProductIssueTrn.aspx?Action=A');" 
                            style="position: relative" type="button" value="Add Job Product Issue" class="button" />
                        </td>
                    </tr>
                </table>
            </td>
                            ...
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Job No." SortExpression="JobNo">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblJobNo" runat="server" Width="165px" Text='<%# DataBinder.Eval(Container, "DataItem.JobNo") %>'>
                                            </asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:BoundColumn DataField="JobStatus" HeaderText="Job Status" SortExpression="JobStatus">
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Width="4%" Wrap="False" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="ProductAmt" HeaderText="Product Amt." SortExpression="ProductAmt">
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    ...
                                    <asp:TemplateColumn HeaderText="Action">
                                        ...
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Top" Width="20%" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Wrap="False" />
                                        <ItemTemplate>
