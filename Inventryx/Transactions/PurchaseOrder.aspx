<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PurchaseOrder.aspx.cs" Inherits="PurchaseOrder" Title="Untitled Page" %>
        ...
        <tr>
            <td align="left" colspan="2" style="width: 740px; height: 22px">
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Purchase Order Listing</asp:Label>
                        </td>
                        <td align="right">
                            <input id="btnAdd" runat="server" name="btnAdd" onclick ="javascript:GotoPage('PurchaseOrderMaster.aspx?Action=A');" 
                            style="position: relative" type="button" value="Add Purchase Order" class="button" />
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td valign="top" style="height: 115px">
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Order No" SortExpression="PurchaseOrderNo">
                                        <HeaderStyle Font-Bold="True" Width="10%" Wrap="False" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblPurchaseOrderNo" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PurchaseOrderNo") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Order Date" SortExpression="PurchaseOrderDate">
                                        <HeaderStyle Font-Bold="True" Width="5%" Wrap="False" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblPurchaseOrderDate" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.PurchaseOrderDate","{0:dd/MM/yyyy}") %>'>
                                                                                                   
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Date of Delivery" SortExpression="DateofDelivery">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblDateofDelivery" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.DateofDelivery","{0:dd/MM/yyyy}") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Supplier" SortExpression="SupplierName">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblSupplier" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.SupplierName") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    ...
                                    <asp:TemplateColumn HeaderText="Order Amount" SortExpression="PurchaseOrderAmt">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblPurchaseOrderAmt" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PurchaseOrderAmt") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateColumn HeaderText="Action">
                                        ...
                                        <ItemTemplate>
                                            ...
                                            <asp:ImageButton ID="btnClose" runat="server" 
                                                CommandName="Close" ImageUrl="../images/Delete.gif" title="Close this purchase order" />
