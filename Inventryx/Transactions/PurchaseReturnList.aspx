<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PurchaseReturnList.aspx.cs" Inherits="Transactions_PurchaseReturnList" Title="Untitled Page" %>
        ...
        <tr>
            <td align="left" colspan="2" style="width: 740px; height: 22px">
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Purchase Return Listing</asp:Label>
                        </td>
                        <td align="right">
                            <input id="btnAdd" runat="server" name="btnAdd" onclick ="javascript:GotoPage('PurchaseReturn.aspx?Action=A');" 
                            style="position: relative" type="button" value="Add New Purchase Return" class="button" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="width: 730px; height: 120px;"><br/>
                <table id="TabCurrency" border="0" cellpadding="3" cellspacing="1" class="tabborder"
                    width="100%">
                    <tr>
                        <td valign="top" style="height: 115px; width: 729px;">
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="PRet No" SortExpression="DeliveryNoteNo">
                                    ...
                                    <asp:TemplateColumn HeaderText="PRet Date" SortExpression="DeliveryNoteDate">
                                    ...
                                    <asp:TemplateColumn HeaderText="Supplier Name" SortExpression="SupplierName">
                                        <HeaderStyle Font-Bold="True" Width="25%" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Wrap="False" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblSupplierName" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.SupplierName") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Delivery Note No" SortExpression="ProformaInvNo">
