<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master"  CodeFile="JobDetails.aspx.cs" Inherits="Transactions_JobDetails" %>
        ...
        <tr>
            <td align="left" colspan="2" style="width: 740px; height: 22px">
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Job Details Listing</asp:Label>
                        </td>
                        <td align="right">
                            <input id="btnAdd" runat="server" name="btnAdd" onclick ="javascript:GotoPage('JobDetailsTrn.aspx?Action=A');" 
                            style="position: relative" type="button" value="Add Job Details" class="button" />
                        </td>
                    </tr>
                </table>
            </td>
                        ...
                        <td valign="top" style="height: 116px; width: 729px;">
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundColumn DataField="JobStartDate" HeaderText="Job Start Date" SortExpression="JobStartDate">
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Width="10%" Wrap="False" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="CustomerName" HeaderText="Customer" SortExpression="CustomerName">
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Width="25%" Wrap="False" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="JobStatus" HeaderText="Job Status" SortExpression="JobStatus">
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Width="5%" Wrap="False" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="LabWorkTotal" HeaderText="Lab. Work Total" SortExpression="LabWorkTotal">
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
