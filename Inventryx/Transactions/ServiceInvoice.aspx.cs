...
public partial class Transactions_ServiceInvoice : BasePage
{
    ...
    string Tables = "vw_TrnInvoiceHdr";
    string PK = "InvoiceNo";
    string Fields = "InvoiceNo,InvoiceDate,CustomerName,ProductTotalAmt,InvoiceStatus";
    string Filter = "";
    string Group = "";
    string sSortCol = "InvoiceNo";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Utility.RedirectToLoginPage("ServiceInvoice.aspx");
        }
        ...
        if (!IsPostBack)
        {
            ...
            Utility.FillFilterDropDown(this.ddSearchField1, "SearchFieldDesc", "SearchFieldID", "SF", "ServiceInvoice");
            Utility.FillFilterDropDown(this.ddSearchCondition1, "FilterDesc", "FilterID", "FC", "ServiceInvoice");
            Utility.FillFilterDropDown(this.ddSearchCondition2, "FilterDesc", "FilterID", "FC", "ServiceInvoice");
            Utility.FillFilterDropDown(this.ddSearchCondition3, "FilterDesc", "FilterID", "FC", "ServiceInvoice");
            Utility.FillFilterDropDown(this.ddSearchField2, "SearchFieldDesc", "SearchFieldID", "SF", "ServiceInvoice");
            Utility.FillFilterDropDown(this.ddSearchField3, "SearchFieldDesc", "SearchFieldID", "SF", "ServiceInvoice");

            ReadPageState("ServiceInvoice", out PageNumber, out sSortCol, out sSortOrder);
            if (PageNumber > 1)
            {
                PagerCtrl1.CurrentIndex = PageNumber;
                PagerCtrl2.CurrentIndex = PageNumber;
                BuildSql(PageNumber);
                KillSession("ServiceInvoice");
            }
            else
            {
    ...
    protected void dgList_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            {
                string sGotoUrl;
                StorePageState("ServiceInvoice", PagerCtrl1.CurrentIndex, sSortCol, sSortOrder);
                sGotoUrl = "ServiceInvoiceView.aspx?Action=C&ID=" + ((Label)e.Item.FindControl("lblInvoiceNo")).Text.Trim();
            ...
            else if (e.CommandName == "Edit")
            {
                string sGotoUrl;
                StorePageState("ServiceInvoice", PagerCtrl1.CurrentIndex, sSortCol, sSortOrder);
                sGotoUrl = "ServiceInvoiceTrn.aspx?Action=E&ID=" + ((Label)e.Item.FindControl("lblInvoiceNo")).Text.Trim();
                Response.Redirect(sGotoUrl);
            }
            else if (e.CommandName == "View")
            {
                string sGotoUrl;
                StorePageState("ServiceInvoice", PagerCtrl1.CurrentIndex, sSortCol, sSortOrder);
                sGotoUrl = "ServiceInvoiceView.aspx?Action=V&ID=" + ((Label)e.Item.FindControl("lblInvoiceNo")).Text.Trim();
                Response.Redirect(sGotoUrl);
            }
    ...
    protected void dgList_ItemDataBound(object sender, DataGridItemEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item)
        {
            ...
            string s = (string)(DataBinder.Eval(e.Item.DataItem, "InvoiceStatus"));

            if ((string)(DataBinder.Eval(e.Item.DataItem, "InvoiceStatus")) == "CAN")
            {
