<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ProductGroup.aspx.cs" Inherits="ProductGroup" Title="Product Group" %>
                ...
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left" style="height: 22px">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Product Group Listing</asp:Label>
                        </td>
                        <td align="right" style="height: 22px">
                            <input id="btnAdd" name="btnAdd" runat=server
                            onclick="javascript:GotoPage('ProductGroupMaster.aspx?Action=A');"
                            style="position: relative" type="button" value="Add New ProductGroup" class="button" />
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td valign="top">
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                CellPadding="3" GridLines="Horizontal" Width="89%" OnItemCommand="dgList_ItemCommand" 
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Product Group ID" SortExpression="ProductGroupID">
                                    ...
                                    <asp:BoundColumn DataField="ProductGroupName" HeaderText="Product Group Name" SortExpression="ProductGroupName">
