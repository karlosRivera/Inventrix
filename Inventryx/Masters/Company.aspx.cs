...
public partial class Company :BasePage
{
    ...
    string Tables = "vw_MstCompany";
    string PK = "CompanyID";
    string Fields = "CompanyID,CompanyName,PANNo,RegNo,VATNo,URL";
    string Filter = "";
    string Group = "";
    string sSortCol = "CompanyID";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            Utility.FillFilterDropDown(this.ddSearchField1, "SearchFieldDesc", "SearchFieldID", "SF", "Company");
            Utility.FillFilterDropDown(this.ddSearchCondition1, "FilterDesc", "FilterID", "FC", "Company");
            Utility.FillFilterDropDown(this.ddSearchCondition2, "FilterDesc", "FilterID", "FC", "Company");
            Utility.FillFilterDropDown(this.ddSearchCondition2, "FilterDesc", "FilterID", "FC", "Company");
            Utility.FillFilterDropDown(this.ddSearchCondition3, "FilterDesc", "FilterID", "FC", "Company");
            Utility.FillFilterDropDown(this.ddSearchField2, "SearchFieldDesc", "SearchFieldID", "SF", "Company");
            Utility.FillFilterDropDown(this.ddSearchField3, "SearchFieldDesc", "SearchFieldID", "SF", "Company");
    ...
    protected void dgList_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListItemType.Item | e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            {
                object tmpMsg = BLL.Master.Company.Delete(((Label)e.Item.FindControl("lblCompanyID")).Text.Trim(), "D");
            ...
            {
                string sGotoUrl;
                sGotoUrl = "CompanyAdmin.aspx?Action=E&ID=" + ((Label)e.Item.FindControl("lblCompanyID")).Text.Trim();
                Response.Redirect(sGotoUrl);
            }
            else if (e.CommandName == "View")
            {
                string sGotoUrl;
                sGotoUrl = "CompanyView.aspx?Action=V&ID=" + e.CommandArgument.ToString();
                Response.Redirect(sGotoUrl);
            }
        }
    }
