<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DepartmentMaster.aspx.cs" Inherits="DepartmentMaster" Title="Untitled Page" %>
    ...
    <table align="center" border="0" cellpadding="1" cellspacing="0" style="position: relative; height: 163px;" width="100%">
        <tr>
            <td align="left" colspan="2" style="height: 37px">
                <table id="tblHead1" border="0" cellpadding="2" cellspacing="0" class="topHeading" style="width: 726px">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Font-Size="1.1em" ForeColor="White" Style="position: relative">Department</asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            ...
            <td align="left" colspan="2" style="width: 740px; height: 36px" valign="top">
                ...
                <asp:TextBox ID="txtDepartmentID" runat="server" Columns="8" CssClass="INPUTblack"
                    ...
                    <tr>
                        <td align="left" style="font-weight: bold; width: 136px; height: 17px">
                            Department Name <span style="color: #ff3300"><strong>*</strong></span></td>
                        <td align="left" style="font-weight: bold; width: 500px; height: 17px">
                            <asp:TextBox ID="txtDepartmentName" runat="server" Columns="50" CssClass="INPUTblack"
                    ...
                    <tr>
                        <td align="right" class="entryBoxFooter" colspan="2">
                            ...
                            <input id="btnBack" class="button" onclick="document.location.href='Department.aspx'"
