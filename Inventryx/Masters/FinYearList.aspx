<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FinYearList.aspx.cs" Inherits="FinYearList" Title="Untitled Page" %>
        ...
        <tr>
            <td align="left" colspan="2" style="width: 740px; height: 22px">
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Financial Year Listing</asp:Label>
                        </td>
                        <td align="right">
                            <input id="btnAdd" name="btnAdd" runat="server"
                            onclick ="javascript:GotoPage('FinYearMaster.aspx?Action=A');" 
                            style="position: relative" type="button" value="Add New Financial Year" 
                            class="button" />
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td valign="top" style="height: 115px">
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Financial Year ID" SortExpression="FinYearID">
                                        <HeaderStyle Font-Bold="True" Width="20%" Wrap="False" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblFinYrID" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.FinYearID") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
