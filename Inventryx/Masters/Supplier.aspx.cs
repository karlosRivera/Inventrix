...
public partial class Supplier : BasePage
{
    #region Global variable declaration
        ...
        string Tables = "mstSupplier";
        string PK = "SupplierID";
        string Fields = "SupplierID,SupplierName,MobileNo,Email,VATRegNo,VATRegDate,PANNo";
        string Filter = "";
        string Group = "";
        string sSortCol = "SupplierID";
...
protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Utility.RedirectToLoginPage("Supplier.aspx");
        }
        ...
        if (!IsPostBack)
        {
            ...
            Utility.FillFilterDropDown(this.ddSearchField1, "SearchFieldDesc", "SearchFieldID", "SF","Supplier");
            Utility.FillFilterDropDown(this.ddSearchCondition1, "FilterDesc", "FilterID", "FC", "Supplier");
            Utility.FillFilterDropDown(this.ddSearchCondition2, "FilterDesc", "FilterID", "FC", "Supplier");
            Utility.FillFilterDropDown(this.ddSearchCondition3, "FilterDesc", "FilterID", "FC", "Supplier");
            Utility.FillFilterDropDown(this.ddSearchField2, "SearchFieldDesc", "SearchFieldID", "SF", "Supplier");
            Utility.FillFilterDropDown(this.ddSearchField3, "SearchFieldDesc", "SearchFieldID", "SF", "Supplier");
...
# endregion
    ...
    protected void dgList_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListItemType.Item | e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            {
                object tmpMsg = BLL.Master.Supplier.Delete(((Label)e.Item.FindControl("lblSupplierID")).Text.Trim(), "D");
            ...
            {
                string sGotoUrl;
                sGotoUrl = "SupplierMaster.aspx?Action=E&ID=" + ((Label)e.Item.FindControl("lblSupplierID")).Text.Trim();
                Response.Redirect(sGotoUrl);
            }
            else if (e.CommandName == "View")
            {
                string sGotoUrl;
                sGotoUrl = "SupplierView.aspx?Action=V&ID=" + e.CommandArgument.ToString();
                Response.Redirect(sGotoUrl);
            }
