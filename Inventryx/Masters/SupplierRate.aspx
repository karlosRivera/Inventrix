<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="SupplierRate.aspx.cs" Inherits="SupplierRate" %>
                ...
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left" style="height: 22px">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Supplier Rate Listing</asp:Label>
                        </td>
                        <td align="right" style="height: 22px">
                            <input id="btnAdd" name="btnAdd" runat=server
                            onclick="javascript:GotoPage('SupplierRateMaster.aspx?Action=A');"
                            style="position: relative" type="button" value="Add New Supplier Rate" class="button" />
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td valign="top">
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Supplier Rate ID" SortExpression="SupplierRateID">
                                        <HeaderStyle Font-Bold="True" Wrap="False" Width="15%" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblSupplierRateID" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.SupplierRateID") %>'></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:BoundColumn DataField="SupplierRate" HeaderText="Rate" SortExpression="SupplierRate">
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    ...
                                    <asp:TemplateColumn HeaderText="Action">
                                        ...
                                        <ItemTemplate>
                                        <asp:ImageButton ID="btnView" runat="server" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.SupplierRateID") %>'
