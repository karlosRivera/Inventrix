<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="OpeningStock.aspx.cs" Inherits="Masters_OpeningStock" %>
        ...
        <tr>
            <td align="left" colspan="2" style="width: 740px; height: 22px">
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Opening Stock Listing</asp:Label>
                        </td>
                        <td align="right">
                            <input id="btnAdd" name="btnAdd" runat=server 
                            onclick="javascript:GotoPage('OpeningStockMaster.aspx?Action=A');"
                            style="position: relative" type="button" value="Add New Opening Stock" class="button" />
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td valign="top">
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Opening Stock ID" SortExpression="OpeningStockID">
                                        <HeaderStyle Font-Bold="True" Wrap="False" Width="15%" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblOpeningStockID" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.OpeningStockID") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                    </asp:TemplateColumn>
                                    
                                    <asp:BoundColumn DataField="GRNNo" HeaderText="GRN No." SortExpression="GRNNo">
                                    ...
                                    <asp:BoundColumn DataField="GRNDate" HeaderText="GRN Date" SortExpression="GRNDate">
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    ...
                                    <asp:BoundColumn HeaderText="Product" SortExpression="ProductName" DataField="ProductName">
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" Width="20%" />
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                    </asp:BoundColumn>
                                    
                                    <asp:BoundColumn DataField="StockPointName" HeaderText="StockPoint" SortExpression="StockPointName">
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" Width="20%" />
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="OpeningQty" HeaderText="Opening Qty." SortExpression="OpeningQty">
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    ...
                                    <asp:TemplateColumn HeaderText="Action">
                                        ...
                                        <ItemTemplate>
                                        <asp:ImageButton ID="btnView" runat="server" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.OpeningStockID") %>'
