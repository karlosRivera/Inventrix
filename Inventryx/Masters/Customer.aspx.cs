...
public partial class Customer :BasePage
{
    ...
    #region Global variable declaration
        ...
        string Tables = "mstCustomer";
        string PK = "CustomerID";
        string Fields = "CustomerID,CustomerName,BillingAddress,PhoneNo,MobileNo";
        string Filter = "";
        string Group = "";
        string sSortCol = "CustomerID";
  ...
  protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Utility.RedirectToLoginPage("Cutomer.aspx");
        }
  ...
  # endregion
    ...
    protected void dgList_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListItemType.Item | e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            {
                object tmpMsg = BLL.Master.Customer.Delete(((Label)e.Item.FindControl("lblCustomerID")).Text.Trim(), "D");
            ...
            {
                string sGotoUrl;
                sGotoUrl = "CustomerMaster.aspx?Action=E&ID=" + ((Label)e.Item.FindControl("lblCustomerID")).Text.Trim();
                Response.Redirect(sGotoUrl);
            }
            else if (e.CommandName == "View")
            {
                string sGotoUrl;
                sGotoUrl = "CustomerView.aspx?Action=V&ID=" + e.CommandArgument.ToString();
                Response.Redirect(sGotoUrl);
            }
        }
    }
