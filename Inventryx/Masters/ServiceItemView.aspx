<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ServiceItemView.aspx.cs" Inherits="ServiceItemView" Title="Untitled Page" %>
        ...
        <tr>
            <td align="left" colspan="2">
                <table id="tblHead1" class="topHeading" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Service Item View</asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table id="tblEntry" class="entryBox" border="0" cellpadding="2" cellspacing="0" >
                    ...
                    <tr>
                        ...
                        <td style="width: 500px" align="left">
                            <asp:Label ID="lblServiceItemID" runat="server" Style="position: relative"></asp:Label></td>
                    </tr>
                    <tr >
                        <td style=" font-weight: bold" nowrap  align="left">
                            Service Item &nbsp;Name&nbsp;</td>
                        <td style="width: 500px;" align="left">
                            &nbsp;<asp:Label ID="lblServiceItemName" runat="server" Style="position: relative"></asp:Label></td>
                    </tr>                    
                    <tr>
