<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ProductRate.aspx.cs" Inherits="ProductRate" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" Runat="Server">
 ...
 <table id="Table5" width="100%">
        <tr>
            <td align="left" colspan="2" style="width: 740px; height: 22px">
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Product Rate Listing</asp:Label>
                        </td>
                        <td align="right">
                            <input id="btnAdd" name="btnAdd" runat="server"
                            onclick ="javascript:GotoPage('ProductRateMaster.aspx?Action=A');" 
                            style="position: relative" type="button" value="Add New Product Rate" 
                            class="button" />
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td valign="top" style="height: 115px">
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Rate ID" SortExpression="ProductRateID">
                                        <HeaderStyle Font-Bold="True" Width="10%" Wrap="False" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblProductRateID" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ProductRateID") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Product" SortExpression="ProductID">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblProduct" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ProductID") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Effective Date" SortExpression="EffectiveDate">
                                        <HeaderStyle Font-Bold="True" Width="15%" Wrap="False" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblEffectiveDate" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.EffectiveDate","{0:dd/MM/yyyy}") %>'>                                                                                             
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>                                    
                                    <asp:TemplateColumn HeaderText="Unit Rate" SortExpression="UnitSaleRate">
                                        <HeaderStyle Font-Bold="True" Width="15%" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblUnitSale" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.UnitSaleRate") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>                                    
                                    <asp:TemplateColumn HeaderText="Action">
                                        <HeaderStyle Font-Bold="True"  Wrap="False" HorizontalAlign="Center" Width="10%" />
                                        <ItemStyle HorizontalAlign="Center" Wrap="False" VerticalAlign="Top" Width="20%" />
                                        <ItemTemplate>
        ...
        <tr>
            <td align= "center" style="width: 730px; height: 38px;">
