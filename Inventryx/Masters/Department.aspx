<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Department.aspx.cs" Inherits="Department" Title="Untitled Page" %>
                ...
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left" style="height: 22px">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Department Listing</asp:Label>
                        </td>
                        <td align="right" style="height: 22px">
                            <input id="btnAdd" name="btnAdd" runat=server  
                            onclick="javascript:GotoPage('DepartmentMaster.aspx?Action=A');"
                            style="position: relative" type="button" value="Add New Department" class="button" />
                        </td>
                    </tr>
                </table>
            </td>
                    ...
                    <tr>
                        <td valign="top">
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Department" SortExpression="DepartmentID">
                                    ...
                                    <asp:BoundColumn DataField="DepartmentName" HeaderText="Department Name" SortExpression="DepartmentName">
