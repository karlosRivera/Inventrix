<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Company.aspx.cs" Inherits="Company" %>
...
<script language=javascript src="../Includes/Common.js"></script>
    <table id="Table5" width="100%">
        <tr>
            <td align="left" colspan="2" style="width: 740px; height: 22px">
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Company Listing</asp:Label>
                        </td>
                        <td align="right">
                            <input id="btnAdd" name="btnAdd" runat=server 
                            onclick="javascript:GotoPage('CompanyAdmin.aspx?Action=A');"
                            style="position: relative" type="button" value="Add New Company" class="button" />
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="height: 165px" >
                <table id="TabCurrency" border="0" cellpadding="3" cellspacing="1" class="tabborder" style="width: 100%">
                    <tr>
                        <td valign="top" style="width: 801px">
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                CellPadding="3" GridLines="Horizontal" Width="92%" OnItemCommand="dgList_ItemCommand" 
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="ID" SortExpression="CompanyID">
                                        <HeaderStyle Font-Bold="True" Wrap="False" Width="5%" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblCompanyID" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.CompanyID") %>'></asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                    </asp:TemplateColumn>
                                    
                                    <asp:BoundColumn DataField="CompanyName" HeaderText="Name" SortExpression="CompanyName">
                                    ...
                                    <asp:BoundColumn DataField="PANNo" HeaderText="PAN No" SortExpression="PANNo">
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" Width="10%" />
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="RegNo" HeaderText="Reg. No." SortExpression="RegNo">
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Width="10%" Wrap="False" />
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="VATNo" HeaderText="VAT No." SortExpression="VATNo">
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Width="10%" Wrap="False" />
                                    </asp:BoundColumn>
                                    <asp:BoundColumn DataField="URL" HeaderText="URL" SortExpression="URL">
                                        <HeaderStyle Font-Bold="True" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    ...
                                    <asp:TemplateColumn HeaderText="Action">
                                        ...
                                        <ItemTemplate>
                                        <asp:ImageButton ID="btnView" runat="server" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.CompanyID") %>'
        ...
        <tr>
            <td align="left" style="height: 13px; width: 709px;">
                &nbsp;<cc2:Pager
