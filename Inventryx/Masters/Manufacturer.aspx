<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="Manufacturer.aspx.cs" Inherits="Masters_Manufacturer" %>
        ...
        <tr>
            <td align="left" colspan="2" style="width: 740px; height: 22px">
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em" Width="142px">Manufacturer Listing</asp:Label>
                        </td>
                        <td align="right">
                            <input id="btnAdd" name="btnAdd" runat="server"
                            onclick ="javascript:GotoPage('ManufacturerMaster.aspx?Action=A');" 
                            style="position: relative" type="button" value="Add New Manufacturer" 
                            class="button" />
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td valign="top" style="height: 115px">
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Manufacturer ID" SortExpression="ManufacturerID">
                                        <HeaderStyle Font-Bold="True" Width="10%" Wrap="False" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblManufacturerID" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ManufacturerID") %>'>
																</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Manufacturer Name" SortExpression="ManufacturerName">
                                        <HeaderStyle Font-Bold="True" Width="60%" Wrap="False" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblManufacturerName" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ManufacturerName") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
