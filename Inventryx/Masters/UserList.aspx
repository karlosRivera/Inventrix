<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="UserList.aspx.cs" Inherits="UserList" Title="Untitled Page" %>
        ...
        <tr>
            <td align="left" colspan="2" style="width: 740px; height: 22px">
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">User Listing</asp:Label>
                        </td>
                        <td align="right">
                            <input id="btnAdd" name="btnAdd" runat="server"
                            onclick ="javascript:GotoPage('UserMaster.aspx?Action=A');" 
                            style="position: relative" type="button" value="Add New User" 
                            class="button" />
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td valign="top" style="height: 115px">
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="User ID" SortExpression="UserID">
                                    ...
                                    <asp:TemplateColumn HeaderText="User PWD" SortExpression="UserPWD">
                                        <HeaderStyle Font-Bold="True" Width="20%" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Wrap="False" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblUserPWD" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.UserPWD") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                    ...
                                    <asp:TemplateColumn HeaderText="User Type" SortExpression="UserTypeName">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblUserTypeName" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.UserTypeName") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                            Font-Underline="False" Wrap="False" />
                                    ...
                                    <asp:TemplateColumn HeaderText="Disabled" SortExpression="DisableTag">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblUserDisableTag" runat="server" >
											</asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                    ...
                                    <asp:TemplateColumn HeaderText="Action">
                                        <HeaderStyle Font-Bold="True" HorizontalAlign="Center" Width="10%" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Wrap="False" />
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="10%" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" Wrap="False" />
                                        <ItemTemplate>
