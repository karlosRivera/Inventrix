...
public partial class SupplierRate :BasePage
{
    #region Global variable declaration
    int iPageSize = Convert.ToInt32(ConfigurationManager.AppSettings["RecordsPerPage"]);
    int PageNumber = 1;
    string spName = "PagingQuery";
    string Tables = "vw_MstSupplierRate";
    string PK = "SupplierRateID";
    string Fields = "SupplierRateID,SupplierName,ProductName,EffectiveDate,SupplierRate";
    string Filter = "";
    string Group = "";
    string sSortCol = "SupplierRateID";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            Utility.FillFilterDropDown(this.ddSearchField1, "SearchFieldDesc", "SearchFieldID", "SF", "SupplierRate");
            Utility.FillFilterDropDown(this.ddSearchCondition1, "FilterDesc", "FilterID", "FC", "SupplierRate");
            Utility.FillFilterDropDown(this.ddSearchCondition2, "FilterDesc", "FilterID", "FC", "SupplierRate");
            Utility.FillFilterDropDown(this.ddSearchCondition3, "FilterDesc", "FilterID", "FC", "SupplierRate");
            Utility.FillFilterDropDown(this.ddSearchField2, "SearchFieldDesc", "SearchFieldID", "SF", "SupplierRate");
            Utility.FillFilterDropDown(this.ddSearchField3, "SearchFieldDesc", "SearchFieldID", "SF", "SupplierRate");
    ...
    private void BuildSql(int PageNo)
    {
        ...
        DataSet ds = BLL.Master.SupplierRate.BindGrid(spName, new object[] { Tables, PK, sSortCol, PageNumber, iPageSize, Fields, cFilter, Group, sSortOrder });
    ...
    protected void dgList_SortCommand(object source, System.Web.UI.WebControls.DataGridSortCommandEventArgs e)
    {
        ...
        Utility.HandleSorting(this.dgList, sSortCol, sSortOrder);
    ...
    protected void dgList_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListItemType.Item | e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            {
                object tmpMsg = BLL.Master.SupplierRate.Delete(((Label)e.Item.FindControl("lblSupplierRateID")).Text.Trim(), "D");
            ...
            {
                string sGotoUrl;
                sGotoUrl = "SupplierRateMaster.aspx?Action=E&ID=" + ((Label)e.Item.FindControl("lblSupplierRateID")).Text.Trim();
                Response.Redirect(sGotoUrl);
            }
            else if (e.CommandName == "View")
            {
                string sGotoUrl;
                sGotoUrl = "SupplierRateView.aspx?Action=V&ID=" + e.CommandArgument.ToString();
                Response.Redirect(sGotoUrl);
            }
        }
    }
