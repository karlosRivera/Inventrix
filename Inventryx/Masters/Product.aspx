<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Product.aspx.cs" Inherits="Product" Title="Untitled Page" %>
        ...
        <tr>
            <td align="left" colspan="2" style="width: 740px; height: 22px">
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Product Listing</asp:Label>
                        </td>
                        <td align="right">
                          <input id="btnAdd" name="btnAdd" runat="server"
                            onclick ="javascript:GotoPage('ProductMaster.aspx?Action=A');" 
                            style="position: relative" type="button" value="Add New Product" 
                            class="button" />
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td style="width: 730px; height: 120px;"><br/>
                <table id="TabCurrency" border="0" cellpadding="3" cellspacing="1" class="tabborder"
                    width="100%">
                    <tr>
                        <td valign="top" style="height: 115px; width: 782px;">
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                CellPadding="3" GridLines="Horizontal" Width="810px" OnItemCommand="dgList_ItemCommand" 
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateColumn HeaderText="Product Spec." SortExpression="ProductSpec">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblProductSpec" runat="server" Text='<%# DataBinder.Eval(Container,"DataItem.ProductSpec") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Product Group" SortExpression="ProductGroupID">
                                        <HeaderStyle Font-Bold="True" Width="15%" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblProductGroup" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ProductGroupID") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    
                                    <asp:TemplateColumn HeaderText="Manufacturer" SortExpression="ManufacturerID">
                                        <HeaderStyle Font-Bold="true" Width="5%" />
                                        <ItemTemplate>
                                        <asp:Label ID="lblManufacturer" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ManufacturerID") %>'>
                                        </asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>

                                    <asp:TemplateColumn HeaderText="Unit Of Measure" SortExpression="ProductUOM">
                                        <HeaderStyle Font-Bold="True" Width="20%" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblProductUOM" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ProductUOM") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>

                                    <asp:TemplateColumn HeaderText="Reorder Level" SortExpression="ReorderLevel">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblReorderLevel" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ReorderLevel") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                        <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
