<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="StockPoint.aspx.cs" Inherits="StockPoint" %>
        ...
        <tr>
            <td align="left" colspan="2" style="width: 740px; height: 22px">
                <table id="tblHead1" class="topHeading" align="center" border="0" cellpadding="2" cellspacing="0">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Style="position: relative" ForeColor="White" Font-Size="1.1em">Stock Point Listing</asp:Label>
                        </td>
                        <td align="right">
                            <input id="btnAdd" name="btnAdd" runat="server"
                            onclick ="javascript:GotoPage('StockPointMaster.aspx?Action=A');" 
                            style="position: relative" type="button" value="Add New Stock Point" 
                            class="button" />
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td valign="top" style="height: 115px">
                            <asp:DataGrid ID="dgList" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateColumn HeaderText="Stock Point ID" SortExpression="StockPointID">
                                        <HeaderStyle Font-Bold="True" Width="10%" Wrap="False" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblStockPointID" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.StockPointID") %>'>
																</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
                                    <asp:TemplateColumn HeaderText="Stock Point Name" SortExpression="StockPointName">
                                    ...
                                    <asp:TemplateColumn HeaderText="Stock Point Type" SortExpression="StockPointType">
                                        <HeaderStyle Font-Bold="True" Width="15%" />
                                        <ItemTemplate>
                                            <asp:Label ID="lblStockPointType" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.StockPointType") %>'>
											</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateColumn>
