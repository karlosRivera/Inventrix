<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DepartmentView.aspx.cs" Inherits="DepartmentView" Title="Untitled Page" %>
        ...
        <tr>
            <td align="left" colspan="2" style="height: 37px">
                <table id="tblHead1" border="0" cellpadding="2" cellspacing="0" class="topHeading">
                    <tr>
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Font-Size="1.1em" ForeColor="White" Style="position: relative">Department View</asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table id="Table1" border="0" cellpadding="2" cellspacing="0" class="entryBox">
                    ...
                    <tr>
                        ...
                        <td align="left" style="width: 575px; height: 6px">
                            <asp:Label ID="lblDepartmentID" runat="server" Width="130px"></asp:Label></td>
                    </tr>
                    <tr>
                        <td align="left" style="font-weight: bold; width: 134px; height: 1px">
                            Department Name</td>
                        <td align="left" style="font-weight: bold; width: 575px; height: 1px">
                            <asp:Label ID="lblDepartmentName" runat="server" Font-Bold="False" Width="187px"></asp:Label></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right" class="entryBoxFooter" colspan="4" style="height: 25px">
                            <asp:Button ID="btnPrint" runat="server" CssClass="button" Style="left: -8px;
                                position: relative; top: 0px" Text="Print" Width="53px" /><input id="btnBack" class="button" onclick="document.location.href='Department.aspx'"
