...
public partial class Masters_OpeningStock : BasePage
{
    ...
    string Tables = "vw_MstOpeningStock";
    string PK = "OpeningStockID";
    string Fields = "OpeningStockID,GRNNo,GRNDate,OpeningQty,ProductName,StockPointName";
    string Filter = "";
    string Group = "";
    string sSortCol = "OpeningStockID";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Utility.RedirectToLoginPage("OpeningStock.aspx");
        }
        ...
        if (!IsPostBack)
        {
            ...
            Utility.FillFilterDropDown(this.ddSearchField1, "SearchFieldDesc", "SearchFieldID", "SF", "OpeningStock");
            Utility.FillFilterDropDown(this.ddSearchCondition1, "FilterDesc", "FilterID", "FC", "OpeningStock");
            Utility.FillFilterDropDown(this.ddSearchCondition2, "FilterDesc", "FilterID", "FC", "OpeningStock");
            Utility.FillFilterDropDown(this.ddSearchCondition3, "FilterDesc", "FilterID", "FC", "OpeningStock");
            Utility.FillFilterDropDown(this.ddSearchField2, "SearchFieldDesc", "SearchFieldID", "SF", "OpeningStock");
            Utility.FillFilterDropDown(this.ddSearchField3, "SearchFieldDesc", "SearchFieldID", "SF", "OpeningStock");
    ...
    private void BuildSql(int PageNo)
    {
        ...
        DataSet ds = BLL.Master.OpeningStock.BindGrid(spName, new object[] { Tables, PK, sSortCol, PageNumber, iPageSize, Fields, cFilter, Group, sSortOrder });
    ...
    protected void dgList_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
    {
        ...
        if (e.Item.ItemType == ListItemType.Item | e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            //{
            //    object tmpMsg = BLL.Master.Branch.Delete(((Label)e.Item.FindControl("lblOpeningStockID")).Text.Trim(), "D");
            ...
            {
                string sGotoUrl;
                sGotoUrl = "OpeningStockView.aspx?Action=V&ID=" + e.CommandArgument.ToString();
                Response.Redirect(sGotoUrl);
            }
        }
    }
